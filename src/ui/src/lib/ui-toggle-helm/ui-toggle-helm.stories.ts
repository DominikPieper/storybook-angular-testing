...
import {BrnToggleDirective, BrnToggleGroupModule} from '@spartan-ng/ui-toggle-brain';
...
import { HlmToggleGroupModule } from './ui-toggle-helm.module';
import { HlmButtonDirective } from '../ui-button-helm/lib/hlm-button.directive';
import { hlmP } from '../ui-typography-helm/lib/hlm-p.directive';
...
@Component({
	...
	imports: [BrnToggleGroupModule, HlmToggleGroupModule, HlmButtonDirective, FormsModule, NgForOf],
	template: `
