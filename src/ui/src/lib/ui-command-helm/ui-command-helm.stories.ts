...
import {BrnCommandComponent, BrnCommandImports} from '@spartan-ng/ui-command-brain';
import {BrnDialogImports} from '@spartan-ng/ui-dialog-brain';
import { HlmCommandImports } from './ui-command-helm.module';
...
import { HlmDialogOverlayDirective } from '../ui-dialog-helm/lib/hlm-dialog-overlay.directive';
