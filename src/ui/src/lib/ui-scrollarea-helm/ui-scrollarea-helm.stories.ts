...
import { HlmSeparatorDirective } from '../ui-separator-helm/ui-separator-helm.module';

@Component({
  selector: 'scroll-area-stories',
  standalone: true,
  imports: [NgFor, HlmSeparatorDirective, HlmScrollAreaComponent, NgScrollbarModule],
  template: `
...
const meta: Meta<NgScrollbar> = {
  ...
  decorators: [
    moduleMetadata({
      imports: [HlmScrollAreaComponent, NgScrollbarModule, ScrollAreaStoriesComponent],
    }),
  ],
};
